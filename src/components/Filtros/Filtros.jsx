...
import { filterProductsByCategory, restart, sortProductsByPrice  } from '../../redux/actions';
...
export const Filtros = () => {
    ...
    const allCategories = ['All', ...new Set(allProducts.map((product) => product.category.toLowerCase()))];
  ...
  return (
    ...
    <label className="mr-2" dangerouslySetInnerHTML={{ __html: filtroIcono }} />
