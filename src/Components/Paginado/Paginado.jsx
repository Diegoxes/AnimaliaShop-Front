...
// Products: numero total de productos, Pagination: Funcion para cambiar de página, perPage: Cantidad de productos por página, currentPage: Página actual
export const Paginacion = ({ products, pagination, perPage, currentPage }) => {
  const pagesCount = Math.ceil(products / perPage); //Calcula la cantidad de paginas necesarias para mostrar los productos
  ...
  return (
    <div className={styles.pagination}>
      {/* {currentPage >= 22 ? (
        <h1>¡Lo sentimos, no hay más productos!</h1>
      ) : ( */}
      <>
        <button
          className={
