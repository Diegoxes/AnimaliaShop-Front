...
<<<<<<< HEAD
  ...
  try{
    const formDataToSend = new FormData();
      ...
      const response = await fetch('https://animaliashop-backend.onrender.com/categories/create', {
        method: 'POST',
        headers: {
    ...
    <div className="max-w-md mx-auto bg-white p-6 rounded-md shadow-md mt-8 border border-gray-700">
      ...
      <form onSubmit={onSubmit} encType="multipart/form-data">
        <div className="mb-4">
          ...
          />
          {formErrors.category && (
            <p className="text-red-500 text-xs mt-1">{formErrors.category.message}</p>
          )}
        </div>
